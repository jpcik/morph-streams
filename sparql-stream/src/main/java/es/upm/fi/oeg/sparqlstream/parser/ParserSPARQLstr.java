...
public class ParserSPARQLstr extends SPARQLParser {
	...
	private interface Action {
		void exec(SPARQLStrParser parser) throws Exception;
	}
	...
	private static void perform(Query query, String string, Action action) {
		...
		/*
		 * catch (ParseException ex) { throw new
		 * QueryParseException(ex.getMessage(),
		 * ex,ex.currentToken.beginLine,ex.currentToken.beginColumn); }
		 */
		catch (Throwable th) {
