...
The description of a relational stream is similar to a relation in terms of the \rtwoo language.
...
This is specified in the \textsf{conceptmap-def} element and the \textsf{attributemap-def} elements, as shown in the bottom part of Listing~\ref{list:s2o}.
%\fixme{Change example to fire use case to make consistent with the rest of the paper.}
