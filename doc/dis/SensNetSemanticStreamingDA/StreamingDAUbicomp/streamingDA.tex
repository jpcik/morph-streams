...
\newcommand{\smally}{\fontsize{6}{7}\selectfont}
%\newcommand{\serifa}[1]{\ensuremath{\mathsf{#1}}}
\newcommand{\serifa}[1]{\textsf{\gargantuan{#1}}}
\newcommand{\codiga}[1]{\texttt{\gargantuan{#1}}}
\newcommand{\rtwoo}{\serifa{R\subscript{2}O}}
\newcommand{\stwoo}{\serifa{S\subscript{2}O}}
...
\keywords{Streaming data access, Ontology-based data access, Sensor networks Querying.}

\category{H.3.3}{Information Search and Retrieval}{Miscellaneous}
\category{H.2.3}{Languages}{Query languages}.
...
This work has been supported by (Change for Blind Review). %European Commission project SemSorGrid4Env (FP7-223913).% 
