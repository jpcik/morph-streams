...
Note that the rate at which windows get evaluated is controlled by the \textsf{STEP} defined in the query, which is denoted by $\delta$.% which in the following is captured by $\delta$ in the following expressions.
