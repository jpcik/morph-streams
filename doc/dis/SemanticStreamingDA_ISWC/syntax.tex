...
However, significant improvements have been made that correct the types supported and the semantics of windowing operations. These improvements can be summarised as: %
...
\subsection{\bigstwoo: Expressing Stream-to-Ontology Mappings}
...
An additional attribute \textsf{streamType} has been added, it denotes the kind of stream in terms of data acquisition, \ie pushed or pulled.
