...
As shown in Section \ref{rdfstreams}, C-SPARQL introduces extensions for the support of RDF streams.\ %, mainly time and tuple based windows and registration of queries and streams \cite{Barbieri_2010}.
