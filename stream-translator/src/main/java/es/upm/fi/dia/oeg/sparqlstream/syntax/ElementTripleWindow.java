...
public class ElementTripleWindow extends ElementWindow 

{
    ...
    public ElementTripleWindow(WindowType wt) {
        this.type = wt;
    }
    
    public ElementTripleWindow(long range, long delta, WindowType wt){
        this.range = range;
        this.delta = delta;
        this.type = wt;
    }
